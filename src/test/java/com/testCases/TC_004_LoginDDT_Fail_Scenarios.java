...
public class TC_004_LoginDDT_Fail_Scenarios extends TestBase{
	@Test(priority=1, dataProvider = "LoginTestAllDataArray", dataProviderClass = LoginDataProviderCsv.class, groups = {"master", "fail"})
